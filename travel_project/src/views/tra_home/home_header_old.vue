  ...
  <div>
    ...
    <div class="header">
      ...
      <div class="header-left">
        <div div class="logo">logo</div>
      </div>

      <div class="header-center">
        <router-link to="/home">首页</router-link>
        <router-link to="/friend">找驴友</router-link>
        <router-link to="/guide">导游/陪玩</router-link>
      ...
      <div class="header-right">
        ...
        <!-- <el-dialog v-model="user_login_panel_state" width="35%" :draggable="true">
          <KeepAlive>
            <loginPanel @addUserSuccess="closePanel"></loginPanel>
          </KeepAlive>
        </el-dialog> -->
...
// 设置用户登录面版状态
// const user_login_panel_state = ref(false);
